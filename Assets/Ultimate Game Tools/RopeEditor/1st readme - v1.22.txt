...
[FIX] Improved default rope values so that it doesn't go haywire easily.
[NEW] Added warning message if the user specifies a segment length shorter than the
      separation between the segment start and end.
